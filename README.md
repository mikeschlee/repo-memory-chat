...
A chat interface for querying research papers using LLM-generated semantic memory — no RAG, no vector embeddings. Seeded with 20 arxiv papers on LLM memory research.
